...
from parameter_analyse.spike_oscilation.python_file.simulation.simulation_ring import simulate
from parameter_analyse.spike_oscilation.python_file.analysis.analysis_global import analysis_global
