...
for bVal in Lb:
	for ExIn in Lei:
		...
		np.save('Results2BIN10/AD_popRateInh_ExIn_'+str(ExIn)+'_bval_'+str(bVal)+'Nseed_'+str(0)+'.npy', popRateG1)
		np.save('Results2BIN10/AD_popRateExc_ExIn_'+str(ExIn)+'_bval_'+str(bVal)+'Nseed_'+str(0)+'.npy', popRateG2)
