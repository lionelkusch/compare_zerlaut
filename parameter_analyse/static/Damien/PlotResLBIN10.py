...
for bVal in Lb:
	...
	for ExIn in Lei:
		...
		FRinh = np.load('Results2BIN10/AD_popRateInh_ExIn_'+str(ExIn)+'_bval_'+str(bVal)+'Nseed_'+str(0)+'.npy')
		FRexc = np.load('Results2BIN10/AD_popRateExc_ExIn_'+str(ExIn)+'_bval_'+str(bVal)+'Nseed_'+str(0)+'.npy')
		hmRes[Cnt].append(np.std(FRexc[100::]))
