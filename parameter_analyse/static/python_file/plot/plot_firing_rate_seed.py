...
for b, max_seed in [(0.0, 30), (60.0, 30)]:
    ...
    plt.figure()
    plt.violinplot(np.concatenate([datas['excitatory']['rate']], axis=0), positions=data_global['rate'], showmeans=True, widths=1.0, showmedians=False,
                   showextrema=False, points=1000, bw_method=0.3)
    plt.figure()
    plt.violinplot(np.concatenate([datas['inhibitory']['rate']], axis=0), positions=data_global['rate'], showmeans=True, widths=1.0, showmedians=False,
                   showextrema=False, points=1000, bw_method=0.3)
