...
from parameter_analyse.fitting_procedure.function_fitting_parameters import engin, print_error
...
#                                       print_error=True, print_details=False, print_details_brut=False),  precision=10, separator=', '), ",", sep='')
print("'P_e':", np.array2string(engin(parameters=excitatory_param, parameters_all=params_all, excitatory=True,
                                      MAXfexc=200., MINfexc=0., nb_value_fexc=500,
                                      MAXfout=200.0,
                                      name_file_fig='/home/kusch/Documents/project/Zerlaut/compare_zerlaut/parameter_analyse/fitting_procedure/fitting_40hz/',
                                      nb_value_adaptation=20,
                                      print_error=False, print_details=False, print_details_brut=False),  precision=10, separator=', '), ",", sep='')
# print_error(parameters=excitatory_param, parameters_all=params_all, excitatory=True,
#             MAXfexc=200., MINfexc=0., nb_value_fexc=500, MAXfout=200.0, nb_value_adaptation=20,
#             name_file_fig='/home/kusch/Documents/project/Zerlaut/compare_zerlaut/parameter_analyse/fitting_procedure/fitting/')
